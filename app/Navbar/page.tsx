    ...
    <nav className="bg-white shadow-md">
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`} id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <Link legacyBehavior href="/Portfolio">
            <a className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Portfolio</a>
          </Link>
          <Link legacyBehavior href="/Contact">
            <a className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Contact</a>
          </Link>
        </div>
      </div>
    </nav>
